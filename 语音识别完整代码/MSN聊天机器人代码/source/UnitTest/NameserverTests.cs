...
namespace XihSolutions.DotMSN.Test
{
	...
	public class NameserverTests : TestBase
	{
		...
		public void SetOnline()
		{
			...
			XihSolutions.DotMSN.Contact.StatusChangedEventHandler statusChangedHandler = new XihSolutions.DotMSN.Contact.StatusChangedEventHandler(Owner_StatusChanged);
		...
		public void SetName()
		{
			...
			string name = "DotMSN Ludovít Štúr " + DateTime.Now.ToString();

			CreateWait();
				Client1.Owner.Name = name;
				Client1.Owner.ScreenNameChanged += new XihSolutions.DotMSN.Contact.ContactChangedEventHandler(Owner_ScreenNameChanged);
			Wait(2000);			
		...
		{			
			XihSolutions.DotMSN.Contact.ContactChangedEventHandler contactChangedHandler = new XihSolutions.DotMSN.Contact.ContactChangedEventHandler(NameserverTests_ContactBlocker);
		...
		{						
			...
			XihSolutions.DotMSN.Contact.ContactChangedEventHandler contactChangedHandler = new XihSolutions.DotMSN.Contact.ContactChangedEventHandler(NameserverTests_ContactGroupChanged);
			CreateWait();
